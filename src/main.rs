...
mod tests {
    ...
    fn test_call_indirect_type_f32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f32().to_bits(), 3890.0_f32.to_bits());
    }
    ...
    fn test_call_indirect_type_f64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f64().to_bits(), 3940.0_f64.to_bits());
    }
    ...
    fn test_call_indirect_type_index() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i64(), 100); // Calls id-i64(100)
    }
    ...
    fn test_call_indirect_type_first_i32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i32(), 32); // Calls id-i32(32)
    }
    ...
    fn test_call_indirect_type_first_i64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i64(), 64); // Calls id-i64(64)
    }
    ...
    fn test_call_indirect_type_first_f32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f32().to_bits(), 1.32_f32.to_bits()); // Calls id-f32(1.32)
    }
    ...
    fn test_call_indirect_type_first_f64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f64().to_bits(), 1.64_f64.to_bits()); // Calls id-f64(1.64)
    }
    ...
    fn test_call_indirect_type_second_i32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i32(), 32); // Calls f32-i32(32.1, 32) -> 32
    }
    ...
    fn test_call_indirect_type_second_i64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i64(), 64); // Calls i32-i64(32, 64) -> 64
    }
    ...
    fn test_call_indirect_type_second_f32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f32().to_bits(), 32.0_f32.to_bits()); // Calls f64-f32(64, 32) -> 32
    }
    ...
    fn test_call_indirect_type_second_f64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f64().to_bits(), 64.1_f64.to_bits()); // Calls i64-f64(64, 64.1) -> 64.1
    }
    ...
    fn test_call_indirect_type_all_i32_i64() {
        ...
        assert_eq!(ret[0].to_i64(), 2);
        assert_eq!(ret[1].to_i32(), 1);
    }
    ...
    fn test_call_indirect_dispatch() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i64(), 123);
    }
    ...
    fn test_call_indirect_dispatch_structural_i64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i64(), 9);
    }
    ...
    fn test_call_indirect_dispatch_structural_f32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f32().to_bits(), 9.0_f32.to_bits());
    }
    ...
    fn test_call_indirect_dispatch_structural_f64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f64().to_bits(), 9.0_f64.to_bits());
    }
    ...
    fn test_call_indirect_fac_i64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i64(), 3628800);
    }
    ...
    fn test_call_indirect_fib_i64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i64(), 89);
    }
    ...
    fn test_call_indirect_fac_i32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i32(), 120);
    }
    ...
    fn test_call_indirect_fac_f32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f32().to_bits(), 1.0_f32.to_bits());
        let ret = inst.get_export_func("fac-f32").unwrap().call(vec![Val::Num(Num::F32(5.0))]);
        assert_eq!(ret.unwrap().pop().unwrap().to_f32().to_bits(), 120.0_f32.to_bits());
    }
    ...
    fn test_call_indirect_fac_f64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f64().to_bits(), 1.0_f64.to_bits());
        let ret = inst.get_export_func("fac-f64").unwrap().call(vec![Val::Num(Num::F64(5.0))]);
        assert_eq!(ret.unwrap().pop().unwrap().to_f64().to_bits(), 120.0_f64.to_bits());
    }
    ...
    fn test_call_indirect_fib_i32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i32(), 8);
    }
    ...
    fn test_call_indirect_fib_f32() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f32().to_bits(), 8.0_f32.to_bits());
    }
    ...
    fn test_call_indirect_fib_f64() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f64().to_bits(), 8.0_f64.to_bits());
    }
    ...
    fn test_call_indirect_as_memory_grow_value() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i32(), 1); // Assuming initial memory size is 1 page
    }
    ...
    fn test_call_indirect_as_load_operand() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_i32(), 0); // Expect 0 assuming zero-initialized memory
    }
    ...
    fn test_call_indirect_as_unary_operand() {
        ...
        assert_eq!(ret.unwrap().pop().unwrap().to_f32().to_bits(), 0.0_f32.to_bits());
    }
