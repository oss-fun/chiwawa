            ...
            match event {
                ...
                TraceEvent::Branch => {
                    if handler_index == HANDLER_IDX_BR
                        ...
                        || (HANDLER_IDX_BR_IF_EQ..=HANDLER_IDX_BR_IF_EQZ).contains(&handler_index)
                    {
                        return true;
                    }
                }
...
impl Tracer {
    ...
    fn get_instruction_name(handler_index: usize) -> &'static str {
        match handler_index {
            ...
            HANDLER_IDX_BR_IF_EQ => "cond_br.i32.eq",
            HANDLER_IDX_BR_IF_NE => "cond_br.i32.ne",
            HANDLER_IDX_BR_IF_LT_S => "cond_br.i32.lt_s",
            HANDLER_IDX_BR_IF_LT_U => "cond_br.i32.lt_u",
            HANDLER_IDX_BR_IF_LE_S => "cond_br.i32.le_s",
            HANDLER_IDX_BR_IF_LE_U => "cond_br.i32.le_u",
            HANDLER_IDX_BR_IF_GT_S => "cond_br.i32.gt_s",
            HANDLER_IDX_BR_IF_GT_U => "cond_br.i32.gt_u",
            HANDLER_IDX_BR_IF_GE_S => "cond_br.i32.ge_s",
            HANDLER_IDX_BR_IF_GE_U => "cond_br.i32.ge_u",
            HANDLER_IDX_BR_IF_EQZ => "cond_br.i32.eqz",
