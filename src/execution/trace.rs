...
impl Tracer {
    ...
    fn get_instruction_name(handler_index: usize) -> &'static str {
        match handler_index {
            ...
            HANDLER_IDX_BR_IF_EQ => "br_if.i32.eq",
            HANDLER_IDX_BR_IF_NE => "br_if.i32.ne",
            HANDLER_IDX_BR_IF_LT_S => "br_if.i32.lt_s",
            HANDLER_IDX_BR_IF_LT_U => "br_if.i32.lt_u",
            HANDLER_IDX_BR_IF_LE_S => "br_if.i32.le_s",
            HANDLER_IDX_BR_IF_LE_U => "br_if.i32.le_u",
            HANDLER_IDX_BR_IF_GT_S => "br_if.i32.gt_s",
            HANDLER_IDX_BR_IF_GT_U => "br_if.i32.gt_u",
            HANDLER_IDX_BR_IF_GE_S => "br_if.i32.ge_s",
            HANDLER_IDX_BR_IF_GE_U => "br_if.i32.ge_u",
            HANDLER_IDX_BR_IF_EQZ => "br_if.i32.eqz",
